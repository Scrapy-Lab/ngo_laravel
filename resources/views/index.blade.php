                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 mt-2">
                        <div class="crd">
                            <div class="image">
                                ...
                                <a href="{{ route('project-details', $project->slug) }}" class="text-center" style="text-decoration: none"><h5 >{{ $project->title }}</h5></a>
                            </div>
                            <div class="content">
                ...
                <div class="col-lg-3 col-md-6 mediaQur">
                    <div class="card Main-cnt">
                        ...
                        <div class="card-body bodyCustom">
                            ...
                            <button class="btn text-white link"><i
                                    class="fa-solid fa-arrow-right"style="margin-right: 5px;"></i>Read more</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col sct-2">
                    <div class="col-lg-4 col-md-12">
                        <img src="{{ asset('images/pexels-carlos-espinoza-2269648.jpg') }}" alt=""
                            class="crds-img" />
                    </div>
