...
<body>
    <div style="max-width: 1020px;width: 100%;position: relative;margin: 0 auto;padding: 10px 0;">
        <div style="display: flex;justify-content: space-between;align-items: center;margin: 0 26px;">
            <img src="{{ public_path('images/mail_images/logo.png') }}" w="20" h="20" alt="logo" style="width: 150px;height: 120px"/>
            <div style="width: 50%; margin-left:300px ; margin-top:-130px">
                <h1 style="color: #cc2121;font-size: 22px;font-family: sans-serif;font-weight: 700;">YOUNGISTAAN WELFARE SOCIETY  (REGD.)  </h1>
        ...
        <div >
            <h3 style="text-align: center;text-decoration: underline;color: #cc2121;font-size: 24px;font-family: sans-serif;">Donation Receipt</h3>
            <div style="color: rgb(29, 87, 202);font-size: 24px;font-family: sans-serif;">Thank you for your gift!</div>
            <p style="font-size: 20px;font-family: sans-serif;letter-spacing: 1.006px;">The amount you have given will make a difference as the proceeds will go help put the children to school
                to give them better education and food. And thus make better member of our organization .
            </p>
            <p style="font-size: 20px;font-family: sans-serif;letter-spacing: 1.006px;">The receipt is an attestation that we have gratefully received your generous contribution to our humble
                institution.</p>
            ...
            <div>
                <div style="font-size: 18px;text-decoration: underline;font-family: sans-serif;margin-bottom: 10px;">DONATION DETAILS:</div>
                <table style="width:100%;height: 120px;">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;font-size: 16px;">{{$data->transaction_type}}
                            {{-- @foreach (json_decode($data->transaction_type) as $donation_type )
                                    {{$donation_type}}
                            @endforeach --}}
                        </td>
                    </tr>
